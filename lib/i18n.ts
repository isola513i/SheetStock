...
const translations = {
  ...
  'login.phone': { th: 'รหัสลูกค้า หรือเบอร์โทรศัพท์', en: 'Customer ID or Phone Number' },
  'login.phonePlaceholder': { th: 'กรอกรหัสลูกค้า หรือเบอร์โทร', en: 'Enter customer ID or phone number' },
  'login.phoneRequired': { th: 'กรุณากรอกรหัสลูกค้า หรือเบอร์โทร', en: 'Please enter your customer ID or phone number' },
