...
const translations = {
  ...
  'login.phone': { th: 'ID หรือเบอร์โทรศัพท์', en: 'ID or Phone Number' },
  'login.phonePlaceholder': { th: 'กรอก ID หรือเบอร์โทร', en: 'Enter ID or phone number' },
  'login.phoneRequired': { th: 'กรุณากรอก ID หรือเบอร์โทร', en: 'Please enter your ID or phone number' },
